...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView,
      ...
      @Nullable EditText name, @NonNull EditText password, @Nullable TextView register,
      @Nullable RelativeLayout rlBack, @Nullable TextView tvTitle, @NonNull EditText username) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, container, loading, login, name,
          password, register, rlBack, tvTitle, username);
    }
