...
public final class DialogFriendInfoBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView dialogInput;
  ...
  private DialogFriendInfoBinding(@NonNull LinearLayout rootView,
      @NonNull Button dialogButtonCancel, @NonNull Button dialogButtonOk,
      @NonNull TextView dialogInput, @NonNull TextView dialogTitle,
  ...
  @NonNull
  public static DialogFriendInfoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogFriendInfoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_friend_info, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogFriendInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView dialogInput = ViewBindings.findChildViewById(rootView, id);
      if (dialogInput == null) {
        break missingId;
      }
      ...
      return new DialogFriendInfoBinding((LinearLayout) rootView, dialogButtonCancel,
          dialogButtonOk, dialogInput, dialogTitle, dialogUsername);
    }
